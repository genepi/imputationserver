...
import genepi.minicloudmac.hadoop.imputation.sort.CompositeKeyComparator;
import genepi.minicloudmac.hadoop.imputation.sort.NaturalKeyGroupingComparator;
import genepi.minicloudmac.hadoop.imputation.sort.NaturalKeyPartitioner;

import org.apache.hadoop.io.Text;
import org.apache.hadoop.mapreduce.Job;

public class MiniMacVcfJob extends HadoopJob {
	...
	public MiniMacVcfJob(String name) {
	...
	public void setupJob(Job job) {
		...
		job.setMapperClass(MiniMacVcfMapper.class);
		...
		job.setReducerClass(MiniMacReducer.class);
